...
import { IUser } from '../types.dev'
 ...
 interface IProps {
   ...
   comment: string,
   //() => void is applied because they are functions
...
//this is comment array
 ...
 const Comments = ({ comment, setComment, addComment, comments, isPostingComment }: IProps ) => {
     ...
     return (
          <div className="border-t-2 border-gray-300 pt-4 px-10 bg-[#F8F8F8] border-b-2 lg:pb-0 pb-[100px]">
              <div className="overflow-scroll lg:h-[475px]">
                {comments?.length ? (
                  ...
                  <NoResults text="No comments yet! Make a comment first!" />
                )}
              </div>
