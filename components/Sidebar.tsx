...
const Sidebar = () => {
     ...
     const normalLink = 'flex items-center gap-3 hover:bg-primary p-3 justify-center xl:justify-center cursor-pointer font-semibold text-[#F51997] rounded';
...
{/* 
                    ...
                    <div className="px-2 py-4 hidden xl:block">
                         <p className="text-gray-500">Log in to like and comment on videos</p>
                         <div className="pr-4">
                              <GoogleLogin
                                clientId=""
                                render={(renderProps) => (
                                   <button
                                   className="bg-white text-lg text-[#F51997] border-[1px] border-[#F51997] cursor-pointer
